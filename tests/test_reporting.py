...
class ReportingTests(unittest.TestCase):
    ...
    def test_aggregate_learning_sequence_results_emits_learning_metrics(self):
        ...
        self.assertEqual(report["benchmark_metadata"]["benchmark_version"], "2.4-learning-b-expanded")
        self.assertEqual(report["benchmark_metadata"]["learning_variant"], "b_expanded")
