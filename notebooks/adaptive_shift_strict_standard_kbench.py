...
(
    adaptive_shift_v3_learning_strict_standard_abstract,
    adaptive_shift_v3_learning_strict_standard_realistic,
    adaptive_shift_v3_learning_strict_standard_overall,
) = get_public_kbench_v3_learning_strict_tasks("standard")

adaptive_shift_v3_learning_strict_standard_overall.run(llm=kbench.llm)
...
try:
    ...
    ip = get_ipython()
    if ip is not None:
        ip.run_line_magic("choose", "adaptive_shift_v3_learning_strict_standard_overall")
except Exception:
    pass
